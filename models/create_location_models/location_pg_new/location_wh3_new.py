...
def list_config_wh3_new() -> list:
	...
	config_wh3_new = [
        ...
        RackConfig_New(
			...
			from_bin = 1,
			to_bin = 32,
			level_config = {i:ord(i)-64 for i in ['B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'K']},
			ft_prefix_chars = {},
			ft_prefix_at_level = {},
			prefix_at_even_odd_bin = None,
			even_odd_both_bin = None,
        ...
        RackConfig_New(
			...
			from_bin = 1,
			to_bin = 32,
			level_config = {i:ord(i)-64 for i in ['H']},
			ft_prefix_chars = {},
			ft_prefix_at_level = {},
			prefix_at_even_odd_bin = None,
			even_odd_both_bin = None,
        ...
        RackConfig_New(
			...
			from_bin = 1,
			to_bin = 35,
			level_config = {i:ord(i)-64 for i in ['F', 'G']},
			ft_prefix_chars = {},
			ft_prefix_at_level = {},
			prefix_at_even_odd_bin = None,
			even_odd_both_bin = None,
        ...
        RackConfig_New(
			...
			ft_prefix_chars = {'G04': 'GT4'},
			ft_prefix_at_level = {'G04': ['G']},
			prefix_at_even_odd_bin = None,
			even_odd_both_bin = None,
			list_bin_ho = [],
			location_usage_type = {},
        ...
        RackConfig_New(
			...
			level_config = {i:ord(i)-64 for i in ['A', 'B', 'C', 'D', 'E', 'F', 'G']},
			ft_prefix_chars = {'G04': 'GT4'},
			ft_prefix_at_level = {'G04': ['D', 'E', 'F', 'G']},
			prefix_at_even_odd_bin = None,
			even_odd_both_bin = None,
			list_bin_ho = [],
			location_usage_type = {},
        ...
        RackConfig_New(
			...
			from_bin = 12,
			to_bin = 13,
			level_config = {i:ord(i)-64 for i in ['B', 'C', 'D', 'E', 'F']},
			ft_prefix_chars = {},
			ft_prefix_at_level = {},
			prefix_at_even_odd_bin = None,
			even_odd_both_bin = None,
