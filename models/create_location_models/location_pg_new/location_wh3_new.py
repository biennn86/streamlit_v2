	...
	config_wh3_new = [
        ...
        RackConfig_New(
		 ...
		 RackConfig_New(
			...
			from_bin = 32,
			to_bin = 32,
			level_config = {i:ord(i)-64 for i in ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'K', 'L', 'M']},
			ft_prefix_chars = {},
			ft_prefix_at_level = {},
			prefix_at_even_odd_bin = None,
			even_odd_both_bin = None,
		...
		FloorConfig_New(
			location_name = ['HOG1RTN', 'HOG01IN', 'HOG02IN', 'HOG03IN', 'HOG04IN', 'HOG05IN', 'HOG06IN',
					'HOG01OUT', 'HOG02OUT', 'HOG03OUT', 'HOG04OUT', 'HOG05OUT', 'HOG06OUT'],
