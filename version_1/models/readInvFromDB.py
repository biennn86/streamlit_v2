...
class CreateDfToDB():
    ...
    def MergeTonkhoMtdataMtLoc(self):
        ...
        #chuyển kiểu giữ liệu giữa 2 df về đồng nhất int64 để khi merge không bị lỗi
        self.dfmasterData['gcas'] = self.dfmasterData['gcas'].astype('int64')
        self.dfTonkho['gcas'] = self.dfTonkho['gcas'].astype('int64')
